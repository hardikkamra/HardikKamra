...
const aboutLinks: LinkItem[] = [
  { title: 'Who I Am', href: '#about', description: 'Personal background and story', icon: Users },
  { title: 'My Journey', href: '#journey', description: 'How I started in finance and data', icon: Star },
  { title: 'Resume / CV', href: '#resume', description: 'Download my resume as PDF', icon: FileText },
];

const skillsLinks: LinkItem[] = [
  { title: 'Microsoft Excel', href: '#skills', icon: BarChart, description: 'Data manipulation & dashboards' },
  { title: 'Power BI', href: '#skills', icon: CodeIcon, description: 'Visual analytics' },
  { title: 'SQL', href: '#skills', icon: CodeIcon, description: 'Database querying' },
  { title: 'SAP', href: '#skills', icon: LayersIcon, description: 'ERP Systems' },
  { title: 'CMA US', href: '#skills', icon: Shield, description: 'In Progress (ICMA)' },
];
    ...
    >
      <nav className="mx-auto flex h-14 w-full max-w-5xl items-center justify-between px-4">
        <div className="flex items-center gap-5">
          ...
          <NavigationMenu className="hidden md:flex">
            <NavigationMenuList>
              ...
              <NavigationMenuItem>
                <NavigationMenuTrigger className="bg-transparent">Skills</NavigationMenuTrigger>
                <NavigationMenuContent className="bg-background p-1 pr-1.5">
                  <ul className="bg-popover grid w-[500px] grid-cols-2 gap-2 rounded-md border p-2 shadow">
                    {skillsLinks.map((item, i) => (
                      <li key={i}>
                        <ListItem {...item} />
                      </li>
                    ))}
              ...
              <NavigationMenuLink className="px-4" asChild>
                <a href="#projects" className="hover:bg-accent rounded-md p-2 text-sm font-medium">
                  Projects
                </a>
              </NavigationMenuLink>
              <NavigationMenuLink className="px-4" asChild>
                <a href="#education" className="hover:bg-accent rounded-md p-2 text-sm font-medium">
                  Education
                </a>
              </NavigationMenuLink>
              <NavigationMenuLink className="px-4" asChild>
                <a href="#contact" className="hover:bg-accent rounded-md p-2 text-sm font-medium">
                  Contact
                </a>
              </NavigationMenuLink>
            </NavigationMenuList>
        ...
        <div className="hidden items-center gap-2 md:flex">
          <Button className="bg-gradient-to-r from-violet-600 to-blue-500 hover:from-violet-700 hover:to-blue-600 text-white border-0 shadow-lg shadow-violet-500/25 transition-all">
            Hire Me &rarr;
          </Button>
        </div>
        <Button
      ...
      <MobileMenu open={open} className="flex flex-col justify-between gap-2 overflow-y-auto">
        <NavigationMenu className="max-w-full">
          <div className="flex w-full flex-col gap-y-2">
            ...
            <a href="#projects" className="p-2 font-medium">Projects</a>
            <a href="#education" className="p-2 font-medium">Education</a>
            <a href="#contact" className="p-2 font-medium">Contact</a>
          </div>
        </NavigationMenu>
        <div className="flex flex-col gap-2">
          <Button className="w-full bg-gradient-to-r from-violet-600 to-blue-500 hover:from-violet-700 hover:to-blue-600 text-white border-0 shadow-lg shadow-violet-500/25">
            Hire Me &rarr;
          </Button>
        </div>
      </MobileMenu>
