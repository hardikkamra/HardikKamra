...
export function CinematicHero({
  ...
  const storySteps = [
    ...
    },
    {
      ...
      description: "Optimized Accounts Receivable (AR) aging reports and structured systematic collection follow-ups, boosting monthly cash inflow by 10%.",
      metricValue: 10,
    ...
    },
    {
      ...
      description: "Automated recurring financial workflows using Advanced Excel macros and shortcuts, reducing monthly reporting turnaround times by 20%.",
      metricValue: 20,
    ...
    },
    {
      ...
      description: "Streamlined end-to-end billing cycles for over 100 corporate clients, maintaining a 99% invoice accuracy rate across high-volume daily transactions.",
      metricValue: 99,
