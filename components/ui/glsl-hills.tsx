...
export const GLSLHills = ({ width = '100vw', height = '100vh', cameraZ = 125, planeSize = 256, speed = 0.5 }) => {
  ...
  useEffect(() => {
    ...
    // Ensure we take the size from the parent container
    const container = containerRef.current;
    let currentWidth = container.clientWidth;
    let currentHeight = container.clientHeight;
    
    const camera = new THREE.PerspectiveCamera(45, currentWidth / currentHeight, 1, 10000);
    ...
    const init = () => {
      ...
      resize(); // Initial resize to catch exact dimensions
      renderLoop();
    };
